...
#define CLIENT_ID  @"3292160"
#define CLIENT_TAG  @"B5559881B0B9BDEF679305B0F138B969"
...
- (void)viewDidLoad
{
    ...
    NSString *licenseInfo = [[NSBundle mainBundle] objectForInfoDictionaryKey:@"GNLicenseInfo"];
    self.sdkManager = [[GnSdkManager alloc] initWithLicense:licenseInfo error:nil];
